...
public enum Msg {
    ...
    CONTROLLER_ACCESS_DENIED("&cError: &fAccess denied, controller's gate is private or controller is not configured."),
    CONTROLLER_ALREADY_EXISTS("&cError: &fThere is already a controller there, perhaps use a Waygate Key?"),
    CONTROLLER_CONFIGURED("&aSuccess: &fWaygate Controller configured to control Waygate %s."),
    CONTROLLER_CREATED("&aSuccess: &fWaygate Controller online and can be used and edited using a Waygate Key"),
    CONTROLLER_DESTROYED("&cController Disruption: &fWaygate Controller has been disrupted and can no longer function"),
    ...
    EFFECT_RESET_WORLD_COMPLETED("&aSuccess: &fAll gates reset to Nether effect in world: %s!"),
    EFFECT_RESET_WORLD_EMPTY("&cError: &fWorld either does not exist or has no gates to reset."),
    EFFECT_RESET_WORLD_NOT_GIVEN("&cError: &fWorld not specified, please provide a world to reset gates in!"),
    ...
    LORE_CONTROL_NAME("&aWaygate Control Creator"),
    LORE_CONTROL_1("&fCreates a Controller that"),
    LORE_CONTROL_2("&fis able to remotely"),
    LORE_CONTROL_3("&factivate a Waygate."),
    LORE_CONTROL_4(""),
    ...
    MENU_HEADER_CONTROLLER_CONFIGURE("Configure Controller"),
    MENU_LORE_ACTIVATION_EFFECT_1("&fChange the visual effect"),
    MENU_LORE_ACTIVATION_EFFECT_2("&fof the gate when it"),
    MENU_LORE_ACTIVATION_EFFECT_3("&factivates."),
    ...
    MENU_TEXT_ACTIVATION_EFFECT_MAGIC("&4Magic"),
    MENU_TEXT_ACTIVATION_EFFECT_NETHER("&5Nether"),
    MENU_TEXT_ACTIVATION_EFFECT_WATER("&9Water"),
    ...
    MENU_TITLE_ACTIVATION_EFFECT("&aActivation Effect"),
    MENU_TITLE_ALWAYS_ON("&aAlways On"),
    MENU_TITLE_CANCEL("&aCancel"),
    MENU_TITLE_CONTROLLER_OWNER("&aController Owner"),
    ...
    MENU_TITLE_NETWORK_ICON("&aNetwork Icon"),
    MENU_TITLE_NETWORK_INVITE_ADD("&aAdd Player"),
    MENU_TITLE_NETWORK_INVITE_EXISTING("&aActive Player"),
    MENU_TITLE_NETWORK_INVITE_MANAGE("&aManage Invites"),
    MENU_TITLE_NETWORK_NAME("&aNetwork Name"),
    ...
    MENU_TITLE_RECONFIGURE_CONTROLLER("&aReconfigure Controller"),
    ...
    NETWORK_CHANGE_ICON("&6While sneaking, right click Gate with new icon to change %s Network icon."),
    NETWORK_CHANGE_ICON_FAILURE("&cError: &fNetwork cannot be assigned a system icon!"),
    NETWORK_CHANGE_ICON_SUCCESS("&aSuccess: &fNetwork icon updated!"),
    ...
    NETWORK_CHANGE_NAME("&6Enter new name for Network (max %d characters):"),
    NETWORK_CHANGE_NAME_SUCCESS("&aSuccess: &fNetwork renamed to %s!"),
