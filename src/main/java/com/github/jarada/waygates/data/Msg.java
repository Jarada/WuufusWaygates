...
public enum Msg {
    ...
    GATE_COST_FAILURE("&cError: &fYou are trying to go %s blocks and need %s diamond(s). Diamond blocks can be used in place of 9 diamonds."),
    ...
    MENU_LORE_GATE_COST("&aCost: &f%s diamond(s)"),
